...
class LoadingScreen(QWidget):
    ...
    def __initUi(self, description_text):
        ...
        loading_screen_ico_filename = os.path.join(caller_path, 'imgs/loading.gif')
    ...
    def start(self):
        ...
        opacity_effect = QGraphicsOpacityEffect(opacity=0.30)
    ...
    def eventFilter(self, obj, e):
        ...
        return super(LoadingScreen, self).eventFilter(obj, e)


class LoadingThread(QThread):
    loadingSignal = pyqtSignal()

    def __init__(self, loading_screen: LoadingScreen, *args, **kwargs):
